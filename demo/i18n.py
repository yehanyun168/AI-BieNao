...
TRANSLATIONS = {
    LANG_ZH: {
        ...
        'restart_button': '再来一局',
        'back_to_menu': '返回主菜单',
        'back_to_menu_confirm_title': '返回主菜单',
        'back_to_menu_confirm_body': '确认要返回主菜单吗？当前进度将自动保存。',
        'back_to_menu_ok': '确认返回',
        'save_button': '存档',
        'load_button': '读档',
        'load_ok': '读档成功',
        'load_fail': '没有可用存档',
    ...
    'stat_countries': 'Countries',
        ...
        'back_to_menu_confirm_title': 'Return to Main Menu',
        'back_to_menu_confirm_body': 'Return to Main Menu? Current progress will be auto-saved.',
        'back_to_menu_ok': 'Confirm',
        'save_button': 'Save',
        'load_button': 'Load',
        'load_ok': 'Loaded',
